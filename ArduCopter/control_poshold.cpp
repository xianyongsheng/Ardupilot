...
#define POSHOLD_CONTROLLER_TO_PILOT_MIX_TIMER   (50*3)  // Set it from 100 to 200, the number of centiseconds loiter and manual commands are mixed to make a smooth transition.
...
#define LOOP_RATE_FACTOR                        1//4       // used to adapt PosHold params to loop_rate
...
#define POSHOLD_STICK_RELEASE_SMOOTH_ANGLE      100//1800    // max angle required (in centi-degrees) after which the smooth stick release effect is applied
