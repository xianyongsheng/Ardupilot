...
#define POSHOLD_CONTROLLER_TO_PILOT_MIX_TIMER   (50*3)//(50*4)  // Set it from 100 to 200, the number of centiseconds loiter and manual commands are mixed to make a smooth transition.
