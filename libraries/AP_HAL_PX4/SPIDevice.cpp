...
#endif
#if defined(PX4_SPIDEV_MPU_1)
    SPIDesc("mpu6500_1",      PX4_SPI_BUS_SENSORS, (spi_dev_e)PX4_SPIDEV_MPU_1, SPIDEV_MODE3, 1*MHZ, 8*MHZ),
    SPIDesc("mpu6500_2",      PX4_SPI_BUS_SENSORS, (spi_dev_e)PX4_SPIDEV_MPU_2, SPIDEV_MODE3, 1*MHZ, 8*MHZ),
#endif
